	...
	public static class set {
		...
		public static String MySQL_String(Connection connection, String SQL, Object... objects){
			...
			if (i > 0) {
				...
				com.project.log.Project.logs_Pro_file(List.getHashMap(6) + "\t[" + i + "]" + List.getHashMap(7));
		...
		public static void Class_Print_logs(Connection connection, String SQL, Object... objects)  {
			...
			if (i > 0) {
				...
				Project.logs_Pro(2, List.getHashMap(5) + "\t[" + i + "]" + List.getHashMap(7));
			} else {
				//System.out.println("执行失败\t[" + i + "]行受影响");
				Project.logs_Pro(2, List.getHashMap(6) + "\t[" + i + "]" + List.getHashMap(7));
			}
		}
	...
	public static class link {
		...
		public static void connection_print(Connection connection) {
			if (connection != null) {
				...
				Project.logs_Pro(2, List.getHashMap(4));
			} else {
				//System.out.println("链接失败!(Link failed!)");
				Project.logs_Pro(2, List.getHashMap(3));
			}
		}
		...
		public static String connection_string(Connection connection) {
			if (connection != null) {
				Project.logs_Pro_file(List.getHashMap(3));
				return List.getHashMap(3);
			} else {
				Project.logs_Pro_file(List.getHashMap(4));
		...
		public static boolean connection_boolean(Connection connection) {
			Project.logs_Pro_file("值:" + (connection != null));
	...
	public static class get {
		...
		public static String Url_Name_Password_String(String password) {
			if (password.equals(getPassword())) {
				Project.logs_Pro_file(List.getHashMap(11) + getUrl() + "]," + List.getHashMap(12) + ":[" + getName() + "]," + List.getHashMap(13) + ":[" + getPassword() + "]}");
				return List.getHashMap(11) + getUrl() + "]," + List.getHashMap(12) + ":[" + getName() + "]," + List.getHashMap(13) + ":[" + getPassword() + "]}";
			} else {
				Project.logs_Pro_file(List.getHashMap(10) + "!");
		...
		public static void Url_Name_Password_print(String password) {
			if (password.equals(getPassword())) {
				Project.logs_Pro(2, List.getHashMap(11) + ":{" + List.getHashMap(12) + ":[" + getUrl() + "]," + List.getHashMap(12) + ":[" + getName() + "]," + List.getHashMap(13) + ":[" + getPassword() + "]}");
			} else {
				Project.logs_Pro(4, List.getHashMap(10) + "!");
			}
		}
