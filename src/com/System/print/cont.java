...
public class cont {
	public cont(int i, Object print_Text) {
		Project.logs("cont.cont():打印:[" + i + "," + print_Text + "]");
		Print(i, print_Text);
	}

	public cont(Object print_Text) {
		Project.logs("cont.cont():打印:[默认," + print_Text + "]");
		Print(2, print_Text);
	}

	public static void Class_Print(int i, Object print_Text) {
		Project.logs("cont.Class_Print():打印:[" + i + "," + print_Text + "]");
		Print(i, print_Text);
	}

	public static void Class_Print(Object print_Text) {
		Project.logs("cont.Class_Print():打印:[默认," + print_Text + "]");
		Print(2, print_Text);
	}

	public static void Class_Println(Object print_Text) {
		Project.logs("cont.Class_Println():打印:[默认," + print_Text + "]");
		Print(2, print_Text);
	}

	public static void System_Print(int i, Object print_Text) {
		Project.logs("cont.System_Print():打印:[" + i + "," + print_Text + "]");
		Print(i, print_Text);
	}

	public static void System_Print(Object print_Text) {
		Project.logs("cont.System_Print():打印:[默认," + print_Text + "]");
		Print(2, print_Text);
	}

	public static void System_Println(Object print_Text) {
		Project.logs("cont.System_Println():打印:[默认," + print_Text + "]");
		Print(2, print_Text);
	}

	public static void System_Print_logs(int i, Object print_Text) {
		Project.logs("cont.System_Print_logs():打印:[" + i + "," + print_Text + "]");
		logs(i, print_Text);
	}

	public static void System_Print_logs(Object print_Text) {
		Project.logs("cont.System_Print_logs():打印:[默认," + print_Text + "]");
		logs(2, print_Text);
	}

	public static void System_Println_logs(Object print_Text) {
		Project.logs("cont.System_Println_logs():打印:[默认," + print_Text + "]");
		logs(2, print_Text);
	}

	public static void Class_Print_logs(int i, Object print_Text) {
		Project.logs("cont.Class_Print_logs():打印:[" + i + "," + print_Text + "]");
		logs(i, print_Text);
	}

	public static void Class_Print_logs(Object print_Text) {
		Project.logs("cont.Class_Print_logs():打印:[默认," + print_Text + "]");
		logs(2, print_Text);
	}

	public static void Class_Println_logs(Object print_Text) {
		Project.logs("cont.Class_Println_logs():打印:[默认," + print_Text + "]");
		logs(2, print_Text);
	}

	public static void print(int i, Object print_Text) {
		Project.logs("cont.print():打印:[" + i + "," + print_Text + "]");
		Print(i, print_Text);
	}

	public static void print(Object print_Text) {
		Project.logs("cont.print():打印:[默认," + print_Text + "]");
		Print(2, print_Text);
	}

	public static void print(int i) {
		Project.logs("cont.print():打印:[默认,空值]");
		print(i, "");
	}
	...
	public static void println(Object print_Text) {
		Project.logs("cont.println():打印:[默认," + print_Text + "]");
		Print(2, print_Text);
	}

	public static void print_logs(int i, Object print_Text) {
		Project.logs("cont.print_logs():打印:[" + i + "," + print_Text + "]");
		logs(i, print_Text);
	}

	public static void print_logs(Object print_Text) {
		Project.logs("cont.print_logs():打印:[默认," + print_Text + "]");
		logs(2, print_Text);
	}

	public static void println_logs(Object print_Text) {
		Project.logs("cont.println_logs():打印:[默认," + print_Text + "]");
		logs(2, print_Text);
	}
